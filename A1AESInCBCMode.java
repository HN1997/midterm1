...
public class A1AESInCBCMode {
    public static void main(String[] args) throws Exception {
    	...
    	System.out.println("AES with CBC mode : \n");
        ...
        env.add(new Agent("alice") {
            ...
            public void task() throws Exception {
            	...
            	{
            		///////////// Sending /////////////
                	Cipher encrypt = Cipher.getInstance("AES/CBC/PKCS5Padding"); //Encryption with AES in CBC and adding a padding
                    ...
                    final Cipher decrypt = Cipher.getInstance("AES/CBC/PKCS5Padding"); //Instantiate Cipher class with AES in CBC mode + padding
